#!/bin/bash
#
# $Id: assassin.sh 2.8 2016-01-25 19:32:37 cmayer $
#
# assassin.sh
...
while true ; do
	...
	echo "  -- killing appserver unconditionally on $primary" >> $as_log
	remservice -tq $primary appdcontroller stop >> $as_log 2>&1
